...
def parse_arguments():
    ...
    parser.add_argument('--task_key', type=str, required=False, default='olist__olist_orders',
...
def main():
    ...
    try:
        # Read from Bronze
        print(f"Reading data from bronze table: {cfg['bronze_catalog_name']}.{cfg['bronze_schema_name']}.{cfg['bronze_table_name']}")
