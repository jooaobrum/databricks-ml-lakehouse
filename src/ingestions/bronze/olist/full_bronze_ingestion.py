...
def parse_arguments():
    ...
    parser.add_argument('--root_path', type=str, required=True,
                        help='Root path for the ingestion process')
    parser.add_argument('--task_key', type=str, required=False, default='olist__olist_customers',
    ...
    parser.add_argument('--file_format', type=str, required=False, default='csv',
                        help='Source file format (csv, json, parquet, etc.)')
    parser.add_argument('--partitions', type=str, required=False, default='dt_ingestion',
                        help='Comma-separated partition columns')
    parser.add_argument('--delimiter', type=str, required=False, default=',',
                        help='Delimiter for CSV files (,, ;, \\t, etc.)')
    parser.add_argument('--header', type=str, required=False, default='true',
                        help='Whether CSV has header (true/false)')
